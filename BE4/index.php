...
<body>
    ...
    <form action="index.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="fio" name="fio" value="<?= htmlspecialchars(getFormData('fio')) ?> required"
        ...
        <div class="form-group">
            ...
            <input type="tel" id="phone" name="phone" value="<?= htmlspecialchars(getFormData('phone')) ?> required"
